...
ENTRIES = [
    ...
    ("calibration screen (17 measures)", "gamma (real power)", 0.0362, "calibration_profile", False),
    ...
    ("calibration screen (17 measures)", "alpha", 0.1043, "calibration_profile", False),
    ("calibration screen (17 measures)", "heart rate", 0.3361, "calibration_profile", False),
    ("calibration screen (17 measures)", "theta", 0.3374, "calibration_profile", False),
    ("calibration screen (17 measures)", "calibration frac-high", 0.3611, "calibration_profile", False),
    ("calibration screen (17 measures)", "beta", 0.5571, "calibration_profile", False),
