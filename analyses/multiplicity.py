...
ENTRIES = [
    ...
    # This registry records each test as originally specified. hazard_glmm.py
    # refits this one with the dependence between overlapping windows handled;
    # the coefficient holds and the p-value moves to 0.043. Supplementary S9
    # gives the refits and what they imply for this family's Holm values.
    ...
    ("calibration screen (17)", "calibration arousal SD", 0.0016, "calibration_profile", False),
    ("calibration screen (17)", "respiration", 0.0022, "calibration_profile", False),
    ("calibration screen (17)", "HRV", 0.0174, "calibration_profile", False),
    ("calibration screen (17)", "theta/beta", 0.0280, "calibration_profile", False),
    ("calibration screen (17)", "calibration level", 0.0293, "calibration_profile", False),
    ("calibration screen (17)", "beta", 0.0456, "calibration_profile", False),
    ("calibration screen (17)", "calibration volatility", 0.0381, "calibration_profile", False),
    ("calibration screen (17)", "calibration IQR", 0.0420, "calibration_profile", False),
    ("calibration screen (17)", "HRV SD", 0.0485, "calibration_profile", False),
    ("calibration screen (17)", "gamma", 0.1341, "calibration_profile", False),
    ("calibration screen (17)", "heart rate", 0.3361, "calibration_profile", False),
    ("calibration screen (17)", "alpha", 0.3577, "calibration_profile", False),
    ("calibration screen (17)", "calibration frac-high", 0.3611, "calibration_profile", False),
    ("calibration screen (17)", "theta", 0.7223, "calibration_profile", False),
    ("calibration screen (17)", "EDA tonic", 0.7586, "calibration_profile", False),
    ("calibration screen (17)", "pupil", 0.8356, "calibration_profile", False),
    ("calibration screen (17)", "EDA phasic", 0.8840, "calibration_profile", False),

    # -- moderation of the deviation-performance coupling -------------------
    ("group moderation", "continuous sensitivity x %in-band", 0.1925,
     "clustered_statistics", True),
    ("group moderation", "median-split group x %in-band", 0.5380,
     "clustered_statistics", False),
        ("group moderation", "per-subject slopes, sensitive vs tolerant", 0.861,
     "clustered_statistics", False),
    ...
    ("held-out control bands", "retuned universal vs default", 0.064,
     "band_scheme_comparison", False),
        ("held-out control bands", "group widths vs default", 0.354,
     "band_scheme_comparison", False),
    ...
    ("held-out control bands", "width from fitted curve vs default", 0.292,
     "band_scheme_comparison", False),
        ("held-out control bands", "group widths vs retuned", 0.752,
     "band_scheme_comparison", False),
